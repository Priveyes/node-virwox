...
//getGridStatistics('2014-01-01 00:00:00', '2014-01-02 00:00:00').then(console.log);
//getGridList().then(console.log)
//getTerminalList().then(console.log)
//getStatistics().then(console.log)
//getRawTradeData('EUR/SLL', 3600).then(console.log)
//getTradedPriceVolume('EUR/SLL', '2014-01-01 00:00:00', '2014-01-02 00:00:00', {precision:4}).then(console.log);
